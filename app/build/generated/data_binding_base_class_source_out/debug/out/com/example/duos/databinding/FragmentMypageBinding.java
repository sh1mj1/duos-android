...
public final class FragmentMypageBinding implements ViewBinding {
  ...
  private FragmentMypageBinding(@NonNull ConstraintLayout rootView, @NonNull TextView myPageTv) {
  ...
  public static FragmentMypageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMypageBinding((ConstraintLayout) rootView, myPageTv);
    }
