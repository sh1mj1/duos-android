...
object PartnerSearchService {
    fun partnerSearchData(partnerSearchView: PartnerSearchView, userIdx: Int){
        val partnerSearchService = ApplicationClass.retrofit.create(RecommendedPartnerListRetrofitInterface::class.java)

        partnerSearchService.recommendedPartnerList(userIdx).enqueue(object : Callback<RecommendedPartnerResponse>{
            override fun onResponse(
                call: Call<RecommendedPartnerResponse>,
                response: Response<RecommendedPartnerResponse>
            ) {
            ...
            override fun onFailure(call: Call<RecommendedPartnerResponse>, t: Throwable) {
