        ...
        DailyMatchingChatDialog.Builder(this)
            ...
            .setRightButton(object :
                ...
                override fun onDailyMatchingMessageSuccess(dailyMatchingMessageResult: DailyMatchingMessageResult) {
                    ...
                    createdNewChatRoom =
                        dailyMatchingMessageResult.createdNewChatRoom //새로 생성했는가?
                    targetChatRoomIdx =
                        dailyMatchingMessageResult.targetChatRoomIdx  // 생성한 채팅방 인덱스
                    participantList =
                        dailyMatchingMessageResult.participantList      // 채팅방에 추가된 사람들 (나 포함임. 리스트 [1]이 나임.
                    ...
                    intent.apply {
                        ...
                        putExtra(
                            "createdNewChatRoom",
                            createdNewChatRoom
                        )  //새로 생성된 채팅방인가? : Boolean
                        putExtra("targetChatRoomIdx", targetChatRoomIdx)    //채팅룸Idx
                        putExtra("partnerNickName", partnerNickname)        //파트너 이름
                        putExtra("partnerIdx", participantList[1])          //채팅 상대 Player Idx
                        putExtra("isAppointmentExist", false)   //첫 채팅방 생성이므로 약속 없음
                        putExtra("appointmentIdx", -1)          // 첫 채팅방 생성이므로 약속 없음
                    }
                    Log.d(
